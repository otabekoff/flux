...
protected:
  explicit TypeNode(Kind k, SourceLocation loc = {}) : ASTNode(loc), kind(k) {}
};
...
public:
  ...
  static bool classof(const TypeNode *t) { return t->kind == Kind::Named; }
};
...
public:
  ...
  GenericType(std::unique_ptr<NamedType> base, std::vector<TypeNodePtr> args,
              SourceLocation loc = {})
      : TypeNode(Kind::Generic, loc), base(std::move(base)),
        typeArguments(std::move(args)) {}

  static bool classof(const TypeNode *t) { return t->kind == Kind::Generic; }
};
...
public:
  ...
  static bool classof(const TypeNode *t) { return t->kind == Kind::Reference; }
};
...
public:
  ...
  static bool classof(const TypeNode *t) { return t->kind == Kind::MutRef; }
};
...
public:
  ...
  static bool classof(const TypeNode *t) { return t->kind == Kind::Tuple; }
};
...
public:
  ...
  FunctionType(std::vector<TypeNodePtr> params, TypeNodePtr ret,
               SourceLocation loc = {})
      : TypeNode(Kind::Function, loc), paramTypes(std::move(params)),
        returnType(std::move(ret)) {}

  static bool classof(const TypeNode *t) { return t->kind == Kind::Function; }
};
...
public:
  ...
  ArrayType(TypeNodePtr elemType, std::optional<uint64_t> size,
            SourceLocation loc = {})
      : TypeNode(Kind::Array, loc), elementType(std::move(elemType)),
        size(size) {}

  static bool classof(const TypeNode *t) { return t->kind == Kind::Array; }
};
