...
void DiagnosticEngine::emitError(SourceLocation loc, const std::string& message) {
    emit(Diagnostic{DiagnosticSeverity::Error, loc, message, {}, {}});
}

void DiagnosticEngine::emitWarning(SourceLocation loc, const std::string& message) {
    emit(Diagnostic{DiagnosticSeverity::Warning, loc, message, {}, {}});
}

void DiagnosticEngine::emitNote(SourceLocation loc, const std::string& message) {
    emit(Diagnostic{DiagnosticSeverity::Note, loc, message, {}, {}});
}

void DiagnosticEngine::emitFatal(SourceLocation loc, const std::string& message) {
...
std::string DiagnosticEngine::severityString(DiagnosticSeverity severity) const {
    switch (severity) {
